...
public class SlotsGame extends BasicCasinoGame{
	...
	public SlotsGame() {
		super("------------------------------------------------------------------\n" +
                ...
                "2 the same : Win amount you bet \n" + 
                "3 the same : Win 4 times amount you bet \n" + 
                "4 the same : Win 8 times amount you bet", 
                "1) Let's play! \n" + 
	...
	public int play(int selection) {
		...
		do {
			...
			if (bet > Coins.get()) {
				bet = 0;
				Ui.msg("You do not gave enough coins. Please enter a smaller amount of type 0 to go back.");
			}
